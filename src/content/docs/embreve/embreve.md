...
- 💬 Entre no Discord: **https://bolls.tech/discord**
- 🧭 Fique de olho nos anúncios e nos canais de dev

:::tip[Dica]
Se você tiver um caso de uso (chatbot, agente com memória, integrações, etc.), manda lá no Discord — isso ajuda a priorizar o que vem primeiro.
:::

## ✅ O que vai aparecer aqui

- 🧩 **Guia de início rápido** (primeira integração em poucos minutos)
- 🔐 **Autenticação** e boas práticas
- 🧠 **Memória & contexto** (como persistir e recuperar informações)
- 🧪 **Exemplos prontos** e snippets
